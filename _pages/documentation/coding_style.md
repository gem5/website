...
title: Coding Style
parent: codingstyle
permalink: documentation/codingstyle/
---
# Coding Style
...
Each file/class/member should be documented using doxygen style comments. The documentation style to use is presented here: [Documentation Guidelines](http://gem5.org/Source_Code_Documentation) 
