...
We are excited to announce the gem5art project,  a gem5 framework aiming to tackle the issue of reproducibility of gem5 experiments and improving the overall testing infrastructure of gem5.
...
The challenge does not only come from the steep learning curve of setting up the experiments, but also Linux kernel and gem5 are being actively develop that makes input parameter space larger.
